...
export type UpdateStudentExamSession_ByTeacherIdResult = ServerActionResult<undefined>;
...
export const updateStudentExamSession = async (
    ...
    try {
        if (!data.teacherId || !data.examId || !data.examSessionId) {
          return {
            success: false,
            message:
              "Please provide teacherId, examId, teacherId, and sessionId",
          };
        }
