...
const page = (props: Props) => {
  return (
    <div className=" w-full h-max p-4 bg-gray-200">
      <span className=" text-3xl font-semibold">Privacy Policy</span>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Gift Qr.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Gift Qr, accessible from{" "}
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>By email: pritamgaindev@gmail.com</li>
      </ul>
    </div>
  );
};
